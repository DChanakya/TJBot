...
while True:
    ...
    if request.strip() != 'bye':
        ...
        if (reply == reply1):
            ...
            mixer.muisc.load("helo.mp3")
            mixer.music.play()

        elif(reply == reply3):
            mixer.muisc.load("iam.mp3")
            mixer.music.play()

        elif (reply == reply4):
            mixer.muisc.load("ican.mp3")
            mixer.music.play()

        elif (reply == reply5):
            mixer.muisc.load("ienter.mp3")
            mixer.music.play()
            ...
            mixer.muisc.load("sorry.mp3")
            mixer.music.play()

        elif (reply == reply8):
            mixer.muisc.load("live.mp3")
            mixer.music.play()

        elif (reply == reply9):
            mixer.muisc.load("love.mp3s")
            mixer.music.play()
